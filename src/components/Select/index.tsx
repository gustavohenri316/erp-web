...
export function Select({
  ...
  let SelectClasses =
    "flex-1 p-2 border rounded-md dark:text-neutral-100 text-neutral-800  outline-none placeholder:text-lg w-full dark:bg-neutral-700 dark:border-neutral-800 ";
