    ...
    <div className="flex items-center justify-between  bg-transparent  py-3">
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between dark:border-neutral-900">
        <div>
          ...
          >
            <button
              className={`relative inline-flex items-center rounded-l-md dark:border-neutral-900 px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 dark:ring-neutral-900 d ${
                currentPage === 1
